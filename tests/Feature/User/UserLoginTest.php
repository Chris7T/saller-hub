...
class UserLoginTest extends TestCase
{
    ...
    public function test_expected_server_error_when_login_action_throw_exception()
    {
        $password = 'password';
        ...
        $userLoginActionMock = Mockery::mock(UserLoginAction::class);
        $userLoginActionMock->shouldReceive('execute')
            ->andThrow(new \Exception('Some error occurred'));
        $this->app->instance(UserLoginAction::class, $userLoginActionMock);
